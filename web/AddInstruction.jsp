...
<body>
    ...
    <div class="container">                
        <h2 style="text-align: center; padding-top: 35px"> <font  color ="black">Enter Instructions</font></h2>
        <div class="row mt-4">
            <form action="oes.controller.InstructionInsert" id="instruction">
                <div class="form-group">
                    <label for="inst">Instruction:</label>
                    <textarea form ="instruction" id="inst" name="inst" rows="5" cols="50" wrap="soft"></textarea><br><br>
                </div>
